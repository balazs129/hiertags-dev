...
},{"backbone":6,"models/graph":2,"underscore":9,"util/file-upload":3,"views/tree":5}],2:[function(require,module,exports){
var Backbone = require('backbone'),
    _ = require('underscore'),
    d3 = require('d3'),
...
//          var isValid = !_.contains(draggingNode._children, dragData.selectedNode) && (draggingNode !== dragData.selectedNode);
